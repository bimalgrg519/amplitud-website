    ...
    <div className="w-full pt-10 flex flex-col justify-start items-start ">
      ...
      {createNewOne && (
        <div className="relative min-h-[50vh] py-16  w-full flex justify-around items-center">
          ...
          <div className=" h-[450px] rounded-xl border border-inputColor flex ">
          ...
          <div className="w-96   flex flex-col justify-center items-center">
            ...
            {checkConfomity(combinations) && (
              <div className=" w-full flex flex-col justify-center items-center text-sm mt-10">
                ...
                <div className="flex justify-between items-center w-full p-2 border-inputColor border rounded-xl">
          ...
          <div className=" h-[450px] rounded-xl border border-inputColor flex relative">
