...
export default connect(
  ...
  return (
    <m.div layout className='flex flex-col justify-center items-center w-full'>
      <m.div layout className='my-2 flex justify-between items-center w-full'>
        <m.div
          layout
          className='p-2 bg-lightGrayCube relative rounded-xl w-48 min-w-[170px] text-center flex items-center justify-around mx-2'
        >
          {traitValidate ? (
            <svg
              width='18'
        ...
        <m.div
          layout
          className='flex w-80  p-2 mx-2 border-2 border-inputColor rounded-2xl'
        >
          {Array(10)
            .fill(0)
            .map((_, i) => {
        ...
        <m.div
          className={`inputTrait border-2 border-lightGray bg-transparent rounded-3xl mx-2 w-34 p-2 pl-4 border-lightGray`}
        >
          <m.input
            onChange={(e: any) => {
        ...
        <m.div
          ...
          className={` w-14 h-14 min-h-[56px] min-w-[56px] rounded-full border-2 border-secondaryColor flex items-center justify-center cursor-pointer  ${
      ...
      <m.div
        layout
        className={`  w-full px-10 flex flex-col justify-start items-start ${
          open ? "h-auto opacity-1" : "h-0 opacity-0"
        }`}
      >
        <m.h2 layout className='font-gilroy-bold text-xl mb-8'>
          Attribute types
        </m.h2>
        <m.div layout className='flex w-full justify-start mb-8'>
          ...
          <m.h3 className='w-4/12 text-end px-2 pr-16 2xl:text-center'>
            No. of NFTs
          </m.h3>
        </m.div>
        ...
        <m.div
          layout
          className={`w-full ${
            detail?.attributes.length > 3 ? "h-80" : "h-auto"
          } flex flex-col overflow-y-scroll mb-10`}
        >
