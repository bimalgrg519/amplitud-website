...
export default function Footer() {
  return (
    <m.footer layout className="section-container">
      <div
        className="flex justify-between border-t border-dashed border-secondaryColor 
    large:flex-col h-80 pt-10 pb-16"
      >
        <div className="flex flex-col justify-between large:justify-center large:w-full large:items-center">
          ...
          <h3 className="text-xs large:hidden">
            © 2022 Amplitud, All rights reserved.
          </h3>
        </div>
        <div className=" flex flex-col large:w-full">
          <h3 className="text-sm text-secondaryColor font-semibold">
            Navigate
          </h3>
        ...
        <div className="flex flex-col large:mt-5">
          <h3 className="text-sm text-secondaryColor font-semibold">Social</h3>
        ...
        <div className="flex flex-col justify-between large:mt-5 large:w-full w-[460px]">
          <div>
            <h3 className="text-sm text-secondaryColor font-semibold">
              Join Our Newsletter
            </h3>
            <div className="flex flex-col mt-5 large:h-60 large:mt-2 large:justify-start ">
              <div className="p-1 rounded-full border border-inputColor flex justify-between large:mt-2 ">
                <input
                  type="text"
              ...
              <h4 className="text-xs  w-full text-lightGray mt-4">
                ...
                &nbsp;You will receive email communications from us for
                marketing, informational, and promotional purposes and can
                opt-out at any time.
              </h4>
            </div>
          </div>
