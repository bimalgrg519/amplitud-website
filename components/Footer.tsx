...
export default function Footer() {
  ...
  return (
    <m.footer layout className=" 
    flex h-80 w-11/12 m-auto mt-10 p-4 border-t-2 border-dotted justify-between border-secondaryColor 
    large:flex-col 
    ">
    <div className="flex flex-col justify-between large:justify-center large:w-full large:items-center ">
        ...
        <svg className=" w-14 h-14 large:w-80 large:h-80"  viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h3 className="text-xs min-w-full large:hidden">© 2022 Amplitud, All rights reserved.</h3>
    </div>
    ...
    <div className="  w-96 flex flex-col items-start pt-2 large:mt-5 large:w-full ">
        ...
        <div className=" h-48 flex flex-col mt-5 justify-between  large:h-60 large:mt-2 large:justify-start ">
            ...
            <div className=" justify-center px-10 large:w-full large:flex-col large:justify-center large:items-center  large:mt-4 large:text-center">
                <h3 className=" hidden text-sm mb-2 text-colorText large:block">© 2022 Amplitud, All rights reserved.</h3>
